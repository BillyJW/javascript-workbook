...
const nums = strNums.map((input) => parseInt(input, 10));
//map takes the array strNums and runs parseInt on each 'string' which converts the passed in 'string' to a number in the base of 10 and 
// returns that number into the new .map array
nums;
